...
extern double SIM_router_stat_energy(SIM_router_info_t *info, SIM_router_power_t *router, int print_depth, int max_avg, double buf_rl,double buf_wl,double c_tl, double n_arb,double nvc_read,double nvc_write, int plot_flag, double freq);
