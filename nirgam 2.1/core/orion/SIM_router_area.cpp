...
double SIM_router_area(SIM_router_area_t *router_area)
{
    double Atotal;
    FILE *fp;
    fp=fopen("/home/nirgam-1.1/results/routerArea","w");
    ...
    fprintf(fp,"The unit of all areas as mentioned below is um^2.\n\n");
    fprintf(fp,"Area of Buffers:%g\n",router_area->buffer);
    fprintf(fp,"Area of Crossbars:%g\n",router_area->crossbar);
    fprintf(fp,"Area of VC Allocator:%g\n",router_area->vc_allocator);
    fprintf(fp,"Area of SW Allocator:%g\n\n",router_area->sw_allocator);
    fprintf(fp,"Total Area of a Router:%g",Atotal);
