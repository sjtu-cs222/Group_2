...
#define PARM_TECH_POINT       110
#define PARM_TRANSISTOR_TYPE  NVT   /* transistor type, HVT, NVT, or LVT */
#define PARM_Vdd              1.2

////map

//#define PARM_Freq             2.0e9 // here in hz while in nirgam in Ghz defined in nirgam.config as CLK_FREQ

/* router module parameters */
/* general parameters */

////map
#define PARM_in_port 		NUM_IC	/* # of router input ports */ //map: defined as NUM_IC in constants.h
...
#define PARM_out_port		NUM_OC	//map: defined as NUM_OC in constants.h
...
//#define PARM_flit_width		64	/* flit width in bits */ //defined in nirgam.config as FLITSIZE in bytes, here in bits
...
///map
#define PARM_v_channel		NUM_VCS	/* # of virtual channels per virtual message class*///defined as NUM_VCS in constants.h
...
#define PARM_vc_allocator_type	VC_SELECT	/*vc allocator type, ONE_STAGE_ARB, TWO_STAGE_ARB, VC_SELECT*/
...
#define PARM_vc_select_buf_type		SRAM	/* vc_select buffer type, SRAM or REGISTER */
